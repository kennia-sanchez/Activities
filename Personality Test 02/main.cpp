//Kennia Sanchez A00517129
//Eduardo Trevino A00826674
...
int main(){
    int resp1,resp2,resp3,resp4,resp5,resp6,resp7,resp8,resp9,resp10,resp11,sum, age;
    string name, hobbie;
    string matriz[4];

    Personalidad persona(resp1,resp2,resp3,resp4,resp5,resp6,resp7,resp8,resp9,resp10);
    ...
    do {
        ...
        cin >> age;
        cout << "Cual es tu hobbie favorito?";
        cin >> hobbie;
        ...
        persona.setPersona(resp1, resp2, resp3, resp4, resp5, resp6, resp7, resp8, resp9, resp10);
        sum = persona.getSuma();
